                ...
                <form action="{{ route('projects.store') }}"
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input id="name" name="name" class="input" type="text" placeholder="Project Name" v-model="name">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input id="description" name="description" class="input" type="text" placeholder="Project Description" v-model="description">
